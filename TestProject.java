...
public class TestProject extends Thread{
    ...
    public void run(){
        ...
        while(customers.size() > 0){
            ...
            if(customer.purchase(view.getComputer(randomPC)) == true){
                JOptionPane.showMessageDialog(null, view.getComputer(randomPC).pcType() + " bought by: " + customer.getName() + 
                "\n" + customer.getName() + " walked out!");
            }
